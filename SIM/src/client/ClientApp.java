...
public class ClientApp {
	...
	public ClientApp(String serverip, int port) throws SocketException {
		try {
...
//					(long) 10000);
	...
	static public void main(String[] args) throws Exception {
		...
		ClientApp testclient = new ClientApp(ip, port);
		testclient.login(ip);
		// start interactive
	...
	public static void receive_request_from_client(
		...
		try {
			...
			record_table.online_table.get(from).setLast_update(
					new Timestamp(update_time));
			record_table.online_table.get(from).setCreate_date(
